...
3. Use Playwright, Chrome, or other browser automation only when the source requires rendered browser state, login cookies, or interaction. X/Twitter bookmarks are the main expected browser-authenticated source.
